...
import { useTransactions } from '../../pages/Transactions/atoms/transactionAtoms';
...
export function NewTransactionModal() {
  const { control, register, handleSubmit, formState: { isSubmitting }, reset } = useForm<NewTransactionFormInputs>({ resolver: zodResolver(NewTransactionFormSchema) });
